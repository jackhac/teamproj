<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CPUs.aspx.cs" Inherits="teamproj2.CPUs" %>
...
<div class="row">
		...
		<div class="span10">
			<ul class="breadcrumb">
				...
				<li class="active"><a href="CPUs.aspx">CPUs</a></li>
			</ul>
			<h3>CPUs</h3>
  		<div class="well">
  		<div class="row">
