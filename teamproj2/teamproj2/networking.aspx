<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="networking.aspx.cs" Inherits="teamproj2.networking" %>
...
<div class="row">
		...
		<div class="span10">
			<ul class="breadcrumb">
				...
				<li class="active"><a href="networking.aspx">Networking</a></li>
			</ul>
			<h3>Networking</h3>
  		<div class="well">
  		<div class="row">
