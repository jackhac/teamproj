<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="desktops.aspx.cs" Inherits="teamproj2.desktops" %>
...
<div class="row">
		...
		<div class="span10">
			<ul class="breadcrumb">
				...
				<li class="active"><a href="desktops.aspx">Desktops</a></li>
			</ul>
			<h3>Desktops</h3>
  		<div class="well">
  		<div class="row">
