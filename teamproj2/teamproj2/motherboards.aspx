<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="motherboards.aspx.cs" Inherits="teamproj2.motherboards" %>
...
<div class="span2">
		...
		<div class="span10">
			<ul class="breadcrumb">
				...
				<li class="active"><a href="motherboards.aspx">Motherboards</a></li>
			</ul>
			<h3>Motherboards</h3>
  		<div class="well">
  		<div class="row">
