<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="printers.aspx.cs" Inherits="teamproj2.printers" %>
...
<div class="row">
		...
		<div class="span10">
			<ul class="breadcrumb">
				...
				<li class="active"><a href="printers.aspx">Printers</a></li>
			</ul>
			<h3>Printers</h3>
  		<div class="well">
  		<div class="row">
